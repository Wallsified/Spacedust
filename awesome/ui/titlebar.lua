...
client.connect_signal("request::titlebars", function(c)
    ...
    local titlebar = awful.titlebar(c, {size = dpi(40), position = 'left'})
    ...
    c_button:connect_signal("button::release", function() c:kill() end)

    min_button:connect_signal("button::release",
        ...
        {
            {
                ...
                {buttons = buttons, layout = wibox.layout.fixed.vertical},
                {buttons = buttons, layout = wibox.layout.fixed.vertical},
